namespace FluentHttp
{
    public static class HttpServerExtensions
    {
        ...
        public static HttpServer Head(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("HEAD", path, handler);

        public static HttpServer Post(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("POST", path, handler);

        public static HttpServer Put(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("PUT", path, handler);

        public static HttpServer Delete(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("DELETE", path, handler);

        public static HttpServer Connect(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("CONNECT", path, handler);

        public static HttpServer Options(this HttpServer server, string path, RequestHandler handler)
        ...
        public static HttpServer PropPatch(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("PROPPATCH", path, handler);

        public static HttpServer MkCol(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("MKCOL", path, handler);

        public static HttpServer Copy(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("COPY", path, handler);

        public static HttpServer Move(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("MOVE", path, handler);

        public static HttpServer Lock(this HttpServer server, string path, RequestHandler handler)
        ...
        public static HttpServer MkCalendar(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("MKCALENDAR", path, handler);

        public static HttpServer Report(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("REPORT", path, handler);

        public static HttpServer CheckIn(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("CHECKIN", path, handler);

        public static HttpServer CheckOut(this HttpServer server, string path, RequestHandler handler)
            => server.EndPoint("CHECKOUT", path, handler);

        public static HttpServer Merge(this HttpServer server, string path, RequestHandler handler)
